...
directory=/dd	owner=0 group=0 mode=dr-xr-xr-x
dfile=dd.dldd source=drvr/dd.dldd	owner=0 group=0 mode=-r-xr-xr-x
dfile=dd.info source=drvr/dd.info	owner=0 group=0 mode=-r-xr-xr-x
